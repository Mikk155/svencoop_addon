...
{
	//models
	string GLOCK_W_MODEL        	= "models/mikk/episode_one/weapons/w_glock.mdl";
	string GLOCK_V_MODEL        	= "models/mikk/episode_one/weapons/v_glock.mdl";
	string GLOCK_P_MODEL        	= "models/mikk/episode_one/weapons/p_glock.mdl";
	string GLOCK_A_MODEL        	= "models/mikk/episode_one/weapons/w_glockclip.mdl";
	string GLOCK_MAGEMPTY_MODEL 	= "models/mikk/episode_one/weapons/w_glockclip.mdl";
	//sounds
